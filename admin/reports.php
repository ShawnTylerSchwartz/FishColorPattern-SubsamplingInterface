...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            ...
            <p class="lead">Generate various reports below.</p>

            <a href="user_history.php"><button class="btn btn-block btn-primary" type="button">User Sessions History <i class="fas fa-external-link-alt"></i></button></a>
            <p></p>
			<a href="sampling_history.php"><button class="btn btn-block btn-primary" type="button">Subsampling History <i class="fas fa-external-link-alt"></i></button></a>
