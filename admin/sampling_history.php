...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            ...
            <p class="lead">View fish subsampling session history below. Looking for <a href="user_history.php" target="_blank">User Session History</a>?</p>

            <iframe src="../_outputData.html" width="100%" height="100%" frameborder="0" scrolling="auto" style="min-height: 500px;"></iframe>
