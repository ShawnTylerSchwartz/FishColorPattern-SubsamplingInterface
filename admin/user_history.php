...
<html lang="en">
    ...
    <body>
        ...
        <main class="container">
            ...
            <p class="lead">View user session history below. Looking for <a href="sampling_history.php" target="_blank">Fish Sampling History</a>?</p>

            <iframe src="../_userLookup.html" width="100%" height="100%" frameborder="0" scrolling="auto" style="min-height: 500px;"></iframe>
