            ...
            <div class="collapse navbar-collapse" id="navbarsExampleDefault">
                <ul class="navbar-nav mr-auto">
                    ...
                    <a href="../download_fish.php" target="_blank">
                        <button class="btn btn-secondary" type="button">
                            <i class="fas fa-file-download"></i> Download Fish Subsamples 
                        </button>
                    </a>
                  </ul>
                ...
                foreach ($images as $image) {
                    ...
                    if (in_array($correctUrlImage, $tmpstorage)) {
                        echo "<div class='list-group'>";
                            echo "<a href='../scale_fish.php?image=" . $correctUrlImage . "' class='list-group-item list-group-item-action list-group-item-success' target='_blank'>" . $correctUrlImage . "</a><div style='margin-bottom: 10px;'></div></li>";
                        echo "</div>";
                            $numCompleted++;
                    } else {
                        echo "<div class='list-group'>";
                            echo "<a href='../scale_fish.php?image=" . $correctUrlImage . "' class='list-group-item list-group-item-action list-group-item-danger' target='_blank'>" . $correctUrlImage . "</a><div style='margin-bottom: 10px;'></div></li>";
                            echo "</div>";
                    }
